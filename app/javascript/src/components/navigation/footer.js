...
export const Footer = ()=>{
    return <div className="relative">
        <footer className="text-gray-600 body-font bg-gray-700 absolute w-full ">
            <div
                ...
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="w-10 h-10 text-white p-2 bg-red-700 rounded-full" fill="none"
            ...
            <div className="bg-gray-900">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2020 Dev —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-400 ml-1"
    ...
    //                 <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
    //                     <svg xmlns="http://www.w3.org/2000/svg"
    //                          className="w-10 h-10 text-white p-2 bg-pink-600 rounded-full" fill="none"
    //                          viewBox="0 0 24 24" stroke="currentColor">
    //                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    //                               d="M12 18h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
    //                     </svg>
